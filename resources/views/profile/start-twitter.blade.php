...
<div class="container">
    <div class="row padded">
        <div class="col-md-8 col-md-offset-2">
            ...
            <form action="{{ route('start_twitter') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label class="btn btn-default btn-block">
                                    <input type="radio" name="account_type" value="skill" {{old('account_type') == 'skill' ? 'checked' : ''}}> Promote my skills
                                </label>
                            </div>
                            <div class="col-md-6">
                                <label class="btn btn-default btn-block">
                                    <input type="radio" name="account_type" value="hire" {{old('account_type') == 'hire' ? 'checked' : ''}}> Hire a skilled person
                                </label>
                            </div>
                        </div>
