...
(function (factory) {
  ...
  var isSupportAmd = "function" === 'function' && __webpack_require__(38);
  ...
  */
  ...
  if (agent.hasCodeMirror) {
    if (agent.isSupportAmd) {
      Promise.resolve().then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [!(function webpackMissingModule() { var e = new Error("Cannot find module \"codemirror\""); e.code = 'MODULE_NOT_FOUND';; throw e; }())]; (function (cm) {
        CodeMirror = cm;
